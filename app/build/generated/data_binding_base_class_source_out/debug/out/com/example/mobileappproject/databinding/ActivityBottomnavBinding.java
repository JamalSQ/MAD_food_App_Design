...
public final class ActivityBottomnavBinding implements ViewBinding {
  ...
  private ActivityBottomnavBinding(@NonNull ConstraintLayout rootView,
  ...
  public static ActivityBottomnavBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_bottomnav, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityBottomnavBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBottomnavBinding((ConstraintLayout) rootView, bottomNavigationView,
          flFragment);
    }
