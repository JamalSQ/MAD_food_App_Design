...
public final class ActivityFiftyEightBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFiftyEightBinding(@NonNull ScrollView rootView, @NonNull Button btnorg,
  ...
  @NonNull
  public static ActivityFiftyEightBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFiftyEightBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_fifty_eight, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFiftyEightBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFiftyEightBinding((ScrollView) rootView, btnorg, editTextText2,
