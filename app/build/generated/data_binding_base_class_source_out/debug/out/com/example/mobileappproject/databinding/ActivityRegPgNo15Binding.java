...
public final class ActivityRegPgNo15Binding implements ViewBinding {
  @NonNull
  private final ScrollView rootView;

  @NonNull
  public final Button btnPg15;
  ...
  private ActivityRegPgNo15Binding(@NonNull ScrollView rootView, @NonNull Button btnPg15,
  ...
  @NonNull
  public static ActivityRegPgNo15Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRegPgNo15Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_reg_pg_no15, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRegPgNo15Binding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btnPg15;
      Button btnPg15 = ViewBindings.findChildViewById(rootView, id);
      if (btnPg15 == null) {
        break missingId;
      }
      ...
      return new ActivityRegPgNo15Binding((ScrollView) rootView, btnPg15, editTextTextPassword,
          emailEditText, imageView, tvDet, tvForgetPassword, tvGoogle, tvOr, tvSignInn, tvUsed);
    }
