...
public final class ActivitySearchFoood2Binding implements ViewBinding {
  @NonNull
  ...
  private ActivitySearchFoood2Binding(@NonNull ConstraintLayout rootView, @NonNull CheckBox heart,
      ...
      @NonNull TextView pricing2, @NonNull LinearLayout recomendtext, @NonNull EditText searchbar,
      @NonNull ImageView starrating, @NonNull ImageView starrating1, @NonNull ImageView starrating2,
  ...
  @NonNull
  public static ActivitySearchFoood2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySearchFoood2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_search_foood2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySearchFoood2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySearchFoood2Binding((ConstraintLayout) rootView, heart, heart1, heart2,
          ...
          searchbar, starrating, starrating1, starrating2, tags, title, title1, title2);
    }
