...
public final class ActivityFiftyNineBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFiftyNineBinding(@NonNull ScrollView rootView, @NonNull Button btnorg,
  ...
  @NonNull
  public static ActivityFiftyNineBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFiftyNineBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_fifty_nine, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFiftyNineBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFiftyNineBinding((ScrollView) rootView, btnorg, editTextText2,
