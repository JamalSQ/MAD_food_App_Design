...
public final class FragmentFirst2Binding implements ViewBinding {
  ...
  private FragmentFirst2Binding(@NonNull NestedScrollView rootView, @NonNull Button buttonFirst,
  ...
  public static FragmentFirst2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFirst2Binding((NestedScrollView) rootView, buttonFirst, textviewFirst);
    }
