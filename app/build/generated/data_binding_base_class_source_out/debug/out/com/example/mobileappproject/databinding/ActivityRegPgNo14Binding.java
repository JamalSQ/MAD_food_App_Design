...
public final class ActivityRegPgNo14Binding implements ViewBinding {
  @NonNull
  private final ScrollView rootView;

  @NonNull
  public final Button btnPg14;
  ...
  private ActivityRegPgNo14Binding(@NonNull ScrollView rootView, @NonNull Button btnPg14,
  ...
  @NonNull
  public static ActivityRegPgNo14Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRegPgNo14Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_reg_pg_no14, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRegPgNo14Binding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btnPg14;
      Button btnPg14 = ViewBindings.findChildViewById(rootView, id);
      if (btnPg14 == null) {
        break missingId;
      }
      ...
      return new ActivityRegPgNo14Binding((ScrollView) rootView, btnPg14, editTextTextPassword,
