...
public final class FragmentMapsBinding implements ViewBinding {
  ...
  private FragmentMapsBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout map) {
  ...
  public static FragmentMapsBinding bind(@NonNull View rootView) {
    ...
    return new FragmentMapsBinding((ConstraintLayout) rootView, map);
  }
}
