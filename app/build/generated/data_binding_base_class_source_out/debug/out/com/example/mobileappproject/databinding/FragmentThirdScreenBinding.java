...
public final class FragmentThirdScreenBinding implements ViewBinding {
  ...
  private FragmentThirdScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView imageView3, @NonNull TextView letsGo, @NonNull TextView textView3) {
  ...
  public static FragmentThirdScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.lets_go;
      TextView letsGo = ViewBindings.findChildViewById(rootView, id);
      if (letsGo == null) {
        break missingId;
      }
      ...
      return new FragmentThirdScreenBinding((ConstraintLayout) rootView, imageView3, letsGo,
          textView3);
    }
