...
public final class ActivityYourCartBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityYourCartBinding(@NonNull ConstraintLayout rootView, @NonNull CheckBox heart,
  ...
  @NonNull
  public static ActivityYourCartBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityYourCartBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_your_cart, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityYourCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityYourCartBinding((ConstraintLayout) rootView, heart, heart1, heart2,
